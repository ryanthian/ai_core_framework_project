...
ROLE_FILES = [
    ".ai/agents/document-analyst.md",
    ".ai/agents/document-reviewer.md",
...
TEMPLATES = [
    ".ai/templates/document-intelligence-report.md",
    ".ai/templates/document-review-report.md",
    ".ai/templates/document-manifest.json",
    ".ai/templates/domain-candidate.md",
